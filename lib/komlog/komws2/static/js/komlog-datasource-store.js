...
function processMsgDeleteDatasource(msgData) {
    if (msgData.hasOwnProperty('did')) {
        $.ajax({
            ...
            .then(function(data){
                datasourceStore.deleteLoopRequest(msgData.did,'requestDatasourceConfig')
                datasourceStore.deleteLoopRequest(msgData.did,'requestDatasourceData')
                var datasourceConfig = datasourceStore._datasourceConfig[msgData.did]
                if (datasourceConfig.hasOwnProperty('wid')) {
                    widgetStore.deleteLoopRequest(datasourceConfig.wid,'requestWidgetConfig')
                }
            }, function(data){
