...
class GestaccountSnapshotApiTest(unittest.TestCase):
    ...
    def test_get_snapshot_config_success_snapshot_datapoint(self):
        ...
        self.assertEqual(datapoint['datapointname'],snapshot_config['datapoint_config']['datapointname'])
        self.assertEqual(datapoint['color'],snapshot_config['datapoint_config']['color'])
    ...
    def test_get_snapshot_config_success_snapshot_histogram(self):
        ...
        self.assertEqual({datapoint['pid']:datapoint['color']},snapshot_config['colors'])
    ...
    def test_get_snapshot_config_success_snapshot_multidp(self):
        ...
        self.assertEqual(snapshot_config['datapoints_config'][0]['datapointname'],datapoint['datapointname'])
        self.assertEqual(snapshot_config['datapoints_config'][0]['color'],datapoint['color'])
    ...
    def test_get_snapshots_config_success_some_snapshots(self):
        ...
        for snapshot in snapshots:
            if snapshot['type']==types.TABLE:
                ...
                self.assertEqual({datapoint['pid']:datapoint['color']},snapshot['colors'])
