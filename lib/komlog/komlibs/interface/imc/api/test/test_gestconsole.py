...
class InterfaceImcApiGestconsoleTest(unittest.TestCase):
    ...
    def NOtest_process_message_MONVAR_failure_non_existent_did(self):
    ...
    def NOtest_process_message_MONVAR_success_datapoint_did_not_exist_previously(self):
        ...
        expected_messages={
            ...
            messages.Messages.UPDATE_DATASOURCE_FEATURES_MESSAGE.name:1,
        }
        retrieved_messages={}
    ...
    def NOtest_process_message_MONVAR_success_ds_had_already_others_datapoints(self):
    ...
    def NOtest_process_message_MONVAR_failure_message_requested_twice(self):
        ...
        self.assertEqual(response.status, status.IMC_STATUS_OK)
        self.assertEqual(response.imc_messages['routed'], {})
        self.assertTrue(len(response.imc_messages['unrouted']) == 3)
        expected_messages={
            messages.Messages.UPDATE_QUOTES_MESSAGE.name:1,
            messages.Messages.RESOURCE_AUTHORIZATION_UPDATE_MESSAGE.name:1,
            messages.Messages.UPDATE_DATASOURCE_FEATURES_MESSAGE.name:1,
    ...
    def NOtest_process_message_NEGVAR_failure_non_existent_datapoint(self):
    ...
    def NOtest_process_message_NEGVAR_success(self):
        ...
        self.assertEqual(response.imc_messages['unrouted'][0]._type_, messages.Messages.UPDATE_DATASOURCE_FEATURES_MESSAGE)
    ...
    def NOtest_process_message_POSVAR_failure_non_existent_datapoint(self):
    ...
    def NOtest_process_message_POSVAR_success_requested_twice(self):
    ...
    def NOtest_process_message_POSVAR_error_in_positive_identification(self):
    ...
    def NOtest_process_message_NEWDSW_failure_non_existent_user(self):
    ...
    def NOtest_process_message_NEWDPW_failure_non_existent_user(self):
    ...
    def NOtest_process_message_DELUSER_failure_non_existent_user(self):
    ...
    def NOtest_process_message_DELAGENT_failure_non_existent_agent(self):
    ...
    def NOtest_process_message_DELAGENT_success(self):
    ...
    def NOtest_process_message_DELDS_failure_non_existent_datasource(self):
    ...
    def NOtest_process_message_DELDS_success(self):
    ...
    def NOtest_process_message_DELDP_failure_non_existent_datapoint(self):
    ...
    def NOtest_process_message_DELDP_success(self):
    ...
    def NOtest_process_message_DELDP_success_user_datapoint(self):
    ...
    def NOtest_process_message_DELWIDGET_failure_non_existent_widget(self):
    ...
    def NOtest_process_message_DELWIDGET_success(self):
    ...
    def NOtest_process_message_DELDASHB_failure_non_existent_dashboard(self):
    ...
    def NOtest_process_message_DELDASHB_success(self):
