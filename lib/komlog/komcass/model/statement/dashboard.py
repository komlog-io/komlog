...
STATEMENTS={
    100000:'select bid,uid,dashboardname,widgets,creation_date from mst_dashboard where bid=?',
    100001:'select bid,uid,dashboardname,widgets,creation_date from mst_dashboard where uid=?',
