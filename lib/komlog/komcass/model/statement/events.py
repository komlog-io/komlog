...
STATEMENTS={
            ...
            150001:'select * from dat_user_events where uid=? and date<=? limit ?',
            150002:'select * from dat_user_events where uid=? and date<=? and date>=?',
            150003:'select * from dat_user_events where uid=? and date>=?',
