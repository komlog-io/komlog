...
STATEMENTS={
    60000:'select uid,quote,value from quo_user where uid=?',
    60001:'select uid,quote,value from quo_user where uid=? and quote=?',
    60100:'select aid,quote,value from quo_agent where aid=?',
    60101:'select aid,quote,value from quo_agent where aid=? and quote=?',
    60200:'select did,quote,value from quo_datasource where did=?',
    60201:'select did,quote,value from quo_datasource where did=? and quote=?',
    60300:'select pid,quote,value from quo_datapoint where pid=?',
    60301:'select pid,quote,value from quo_datapoint where pid=? and quote=?',
    60400:'select wid,quote,value from quo_widget where wid=?',
    60401:'select wid,quote,value from quo_widget where wid=? and quote=?',
    60500:'select bid,quote,value from quo_dashboard where bid=?',
    60501:'select bid,quote,value from quo_dashboard where bid=? and quote=?',
    60600:'select cid,quote,value from quo_circle where cid=?',
    60601:'select cid,quote,value from quo_circle where cid=? and quote=?',
