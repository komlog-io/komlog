...
# Free PLAN
    ...
    "insert into prm_user_segment_quo (sid,quote,value) values (0,'quo_user_total_datapoints',50000)",
    "insert into prm_user_segment_quo (sid,quote,value) values (0,'quo_user_total_datasources',10000)",
...
# PERSONAL PLAN
    ...
    "insert into mst_user_segment (sid,description) values (1,'Geek plan')",
    ...
    "insert into prm_user_segment_quo (sid,quote,value) values (1,'quo_daily_user_data_post_counter',25000)",
    "insert into prm_user_segment_quo (sid,quote,value) values (1,'quo_agent_total_datapoints',250000)",
    "insert into prm_user_segment_quo (sid,quote,value) values (1,'quo_agent_total_datasources',50000)",
    ...
    "insert into prm_user_segment_quo (sid,quote,value) values (1,'quo_user_total_datapoints',250000)",
    "insert into prm_user_segment_quo (sid,quote,value) values (1,'quo_user_total_datasources',50000)",
...
# STARTUP PLAN
    ...
    "insert into prm_user_segment_quo (sid,quote,value) values (2,'quo_daily_user_data_post_counter',150000)",
    "insert into prm_user_segment_quo (sid,quote,value) values (2,'quo_agent_total_datapoints',10000000)",
    "insert into prm_user_segment_quo (sid,quote,value) values (2,'quo_agent_total_datasources',1000000)",
    ...
    "insert into prm_user_segment_quo (sid,quote,value) values (2,'quo_user_total_datapoints',10000000)",
    "insert into prm_user_segment_quo (sid,quote,value) values (2,'quo_user_total_datasources',1000000)",
...
# BUSINESS PLAN
    ...
    "insert into prm_user_segment_quo (sid,quote,value) values (3,'quo_daily_user_data_post_counter',1000000)",
    ...
    "insert into prm_user_segment_quo (sid,quote,value) values (3,'quo_user_total_datapoints',10000000)",
    "insert into prm_user_segment_quo (sid,quote,value) values (3,'quo_user_total_datasources',1000000)",
