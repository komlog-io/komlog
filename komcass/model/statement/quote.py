...
STATEMENTS={60000:'select * from quo_user where uid=?',
            ...
            60006:'select * from quo_circle where cid=?',
            ...
            61006:'insert into quo_circle (cid,quotes) values (?,?)',
            ...
            62006:'delete quotes [?] from quo_circle where cid=?',
            62007:'delete from quo_user where uid=?',
            62008:'delete from quo_agent where aid=?',
            62009:'delete from quo_datasource where did=?',
            62010:'delete from quo_datapoint where pid=?',
            62011:'delete from quo_widget where wid=?',
            62012:'delete from quo_dashboard where bid=?',
            62013:'delete from quo_circle where cid=?',
            ...
            63006:'update quo_circle set quotes [?] = ? where cid=?',
           }
...
D_Q_QUODATASOURCE_B_DID=62002
D_Q_QUODATAPOINT_B_PID=62003
D_Q_QUOWIDGET_B_WID=62004
D_Q_QUODASHBOARD_B_BID=62005
D_Q_QUOCIRCLE_B_CID=62006
D_A_QUOUSER_B_UID=62007
D_A_QUOAGENT_B_AID=62008
D_A_QUODATASOURCE_B_DID=62009
D_A_QUODATAPOINT_B_PID=62010
D_A_QUOWIDGET_B_WID=62011
D_A_QUODASHBOARD_B_BID=62012
D_A_QUOCIRCLE_B_CID=62013
