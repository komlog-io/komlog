...
STATEMENTS={120000:'select * from mst_snapshot where nid=?',
            ...
            125100:'insert into mst_snapshot_ds (nid,did) values (?,?)',
            125200:'insert into mst_snapshot_dp (nid,pid) values (?,?)',
            ...
            125600:'insert into mst_snapshot_multidp (nid,active_visualization,datapoints) values (?,?,?)',
