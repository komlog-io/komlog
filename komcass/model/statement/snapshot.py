...
STATEMENTS={120000:'select * from mst_snapshot where nid=?',
            ...
            121001:'insert into mst_snapshot_ds (nid,uid,wid,interval_init,interval_end,widgetname,creation_date,did,shared_with_uids) values (?,?,?,?,?,?,?,?,?)',
            121002:'insert into mst_snapshot_dp (nid,uid,wid,interval_init,interval_end,widgetname,creation_date,pid,shared_with_uids) values (?,?,?,?,?,?,?,?,?)',
            121003:'insert into mst_snapshot_histogram (nid,uid,wid,interval_init,interval_end,widgetname,creation_date,datapoints,colors,shared_with_uids) values (?,?,?,?,?,?,?,?,?,?)',
            121004:'insert into mst_snapshot_linegraph (nid,uid,wid,interval_init,interval_end,widgetname,creation_date,datapoints,colors,shared_with_uids) values (?,?,?,?,?,?,?,?,?,?)',
            121005:'insert into mst_snapshot_table (nid,uid,wid,interval_init,interval_end,widgetname,creation_date,datapoints,colors,shared_with_uids) values (?,?,?,?,?,?,?,?,?,?)',
