...
STATEMENTS={90000:'select * from mst_widget where wid=?',
            ...
            90100:'select * from mst_widget_ds where wid=?',
            90101:'select * from mst_widget_ds where did=?',
            90200:'select * from mst_widget_dp where wid=?',
            90201:'select * from mst_widget_dp where pid=?',
            90300:'select * from mst_widget_histogram where wid=?',
            90301:'select wid from mst_widget_histogram where datapoints contains ?',
            90400:'select * from mst_widget_linegraph where wid=?',
            90401:'select wid from mst_widget_linegraph where datapoints contains ?',
            90500:'select * from mst_widget_table where wid=?',
