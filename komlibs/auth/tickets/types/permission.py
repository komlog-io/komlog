...
NEW_SNAPSHOT_TICKET_DID_PERMISSIONS={
    share.NEW_SNAPSHOT_SHARE_READ_ONLY:permissions.CAN_READ_DATA|permissions.CAN_READ_CONFIG,
    share.NEW_SNAPSHOT_SHARE_READ_AND_SHARE:permissions.CAN_READ_DATA|permissions.CAN_READ_CONFIG,
}
