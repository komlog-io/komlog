...
class AuthQuotesCompareTest(unittest.TestCase):
    ...
    def test_compare_quo_static_user_total_agents_no_uid(self):
        ...
        params={}
        self.assertIsNone(compare.compare_quo_static_user_total_agents(params))

    def test_compare_quo_static_user_total_agents_non_existent_user(self):
        ''' compare_quo_static_user_total_agents should fail if uid does not exist on system '''
    ...
    def test_compare_quo_static_user_total_datasources_no_uid(self):
        ''' compare_quo_static_user_total_datasources should fail if no uid is passed '''
        params={}
        self.assertIsNone(compare.compare_quo_static_user_total_datasources(params))

    def test_compare_quo_static_user_total_datasources_non_existent_user(self):
        ''' compare_quo_static_user_total_datasources should fail if uid does not exist on system '''
        params={'uid':uuid.uuid4()}
        self.assertIsNone(compare.compare_quo_static_user_total_datasources(params))
    ...
    def test_compare_quo_static_user_total_datapoints_no_uid(self):
        ''' compare_quo_static_user_total_datapoints should fail if no uid is passed '''
        params={}
        self.assertIsNone(compare.compare_quo_static_user_total_datapoints(params))

    def test_compare_quo_static_user_total_datapoints_non_existent_user(self):
        ''' compare_quo_static_user_total_datapoints should fail if uid does not exist on system '''
        params={'uid':uuid.uuid4()}
        self.assertIsNone(compare.compare_quo_static_user_total_datapoints(params))
    ...
    def test_compare_quo_static_user_total_widgets_no_uid(self):
        ''' compare_quo_static_user_total_widgets should fail if no uid is passed '''
        params={}
        self.assertIsNone(compare.compare_quo_static_user_total_widgets(params))

    def test_compare_quo_static_user_total_widgets_non_existent_user(self):
        ''' compare_quo_static_user_total_widgets should fail if uid does not exist on system '''
        params={'uid':uuid.uuid4()}
        self.assertIsNone(compare.compare_quo_static_user_total_widgets(params))
    ...
    def test_compare_quo_static_user_total_dashboards_no_uid(self):
        ''' compare_quo_static_user_total_dashboards should fail if no uid is passed '''
        params={}
        self.assertIsNone(compare.compare_quo_static_user_total_dashboards(params))

    def test_compare_quo_static_user_total_dashboards_non_existent_user(self):
        ''' compare_quo_static_user_total_dashboards should fail if uid does not exist on system '''
        params={'uid':uuid.uuid4()}
        self.assertIsNone(compare.compare_quo_static_user_total_dashboards(params))
    ...
    def test_compare_quo_static_agent_total_datasources_no_uid(self):
        ''' compare_quo_static_agent_total_datasources should fail if no uid is passed '''
        params={'aid':uuid.uuid4()}
        self.assertIsNone(compare.compare_quo_static_agent_total_datasources(params))

    def test_compare_quo_static_agent_total_datasources_no_aid(self):
        ''' compare_quo_static_agent_total_datasources should fail if no aid is passed '''
        params={'uid':uuid.uuid4()}
        self.assertIsNone(compare.compare_quo_static_agent_total_datasources(params))

    def test_compare_quo_static_agent_total_datasources_non_existent_user(self):
        ''' compare_quo_static_agent_total_datasources should fail if uid does not exist on system '''
    ...
    def test_compare_quo_static_agent_total_datapoints_no_uid(self):
        ''' compare_quo_static_agent_total_datapoints should fail if no uid is passed '''
        params={'aid':uuid.uuid4()}
        self.assertIsNone(compare.compare_quo_static_agent_total_datapoints(params))

    def test_compare_quo_static_agent_total_datapoints_no_aid(self):
        ''' compare_quo_static_agent_total_datapoints should fail if no aid is passed '''
        params={'uid':uuid.uuid4()}
        self.assertIsNone(compare.compare_quo_static_agent_total_datapoints(params))

    def test_compare_quo_static_agent_total_datapoints_non_existent_user(self):
        ''' compare_quo_static_agent_total_datapoints should fail if uid does not exist on system '''
        params={'uid':uuid.uuid4(),'aid':uuid.uuid4()}
        self.assertIsNone(compare.compare_quo_static_agent_total_datapoints(params))
    ...
    def test_compare_quo_static_datasource_total_datapoints_no_uid(self):
        ''' compare_quo_static_datasource_total_datapoints should fail if no uid is passed '''
        params={'did':uuid.uuid4()}
        self.assertIsNone(compare.compare_quo_static_datasource_total_datapoints(params))

    def test_compare_quo_static_datasource_total_datapoints_no_did(self):
        ''' compare_quo_static_datasource_total_datapoints should fail if no did is passed '''
        params={'uid':uuid.uuid4()}
        self.assertIsNone(compare.compare_quo_static_datasource_total_datapoints(params))

    def test_compare_quo_static_datasource_total_datapoints_non_existent_user(self):
        ''' compare_quo_static_datasource_total_datapoints should fail if uid does not exist on system '''
