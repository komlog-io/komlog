...
class GestaccountDashboardApiTest(unittest.TestCase):
    ...
    def test_get_dashboard_config_success(self):
        ...
        result=dashboardapi.create_dashboard(username=username, dashboardname=dashboardname)
        bid=result['bid']
    ...
    def test_get_dashboards_config_failure_invalid_username(self):
        ...
        usernames=[None, 2342342, 2342342.23423, {'a':'dict'}, ['a','list'],('a','tuple'),{'set'}, uuid.uuid4(), uuid.uuid1(), 'userñame','Username']
        for username in usernames:
            self.assertRaises(exceptions.BadParametersException, dashboardapi.get_dashboards_config, username=username)
    ...
    def test_get_dashboards_config_non_existent_username(self):
        ...
        self.assertRaises(exceptions.UserNotFoundException, dashboardapi.get_dashboards_config, username=username)
    ...
    def test_get_dashboard_config_success_some_dashboards(self):
        ...
        user=userapi.create_user(username=username,password='password',email=username+'@komlog.org')
        result=dashboardapi.create_dashboard(username=username, dashboardname=dashboardname1)
        bid1=result['bid']
        result=dashboardapi.create_dashboard(username=username, dashboardname=dashboardname2)
        bid2=result['bid']
        config=dashboardapi.get_dashboards_config(username=username)
        counter=0
    ...
    def test_create_dashboard_failure_invalid_username(self):
        ...
        for username in usernames:
            self.assertRaises(exceptions.BadParametersException, dashboardapi.create_dashboard, username=username, dashboardname=dashboardname)
    ...
    def test_create_dashboard_failure_invalid_dashboardname(self):
        ...
        username='test_create_dashboard_failure_invalid_username'
    ...
    def test_create_dashboard_failure_non_existing_user(self):
        ...
        username='test_create_dashboard_failure_non_existing_user'
        dashboardname='test_create_dashboard_failure_non_existing_user'
        self.assertRaises(exceptions.UserNotFoundException, dashboardapi.create_dashboard, username=username, dashboardname=dashboardname)
