...
MODULES = [
    ...
    'komlibs.auth.tickets.test.test_provision.AuthTicketsProvisionTest',
    'komlibs.auth.tickets.test.test_authorization.AuthTicketsAuthorizationTest',
    ...
    'komcass.api.test.test_ticket.KomcassApiTicketTest',
    ...
    'komlibs.interface.web.api.test.test_login.InterfaceWebApiLoginTest',
    ...
    'komlibs.interface.websocket.protocol.v1.model.test.test_response.InterfaceWebSocketProtocolV1ModelResponseTest',
    'komlibs.interface.websocket.protocol.v1.model.test.test_message.InterfaceWebSocketProtocolV1ModelMessageTest',
    'komlibs.interface.websocket.protocol.v1.model.test.test_operation.InterfaceWebSocketProtocolV1ModelOperationTest',
    'komlibs.interface.websocket.protocol.v1.processing.test.test_operation.InterfaceWebSocketProtocolV1ProcessingOperationTest',
